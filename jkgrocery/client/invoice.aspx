<%@ Page Title="" Language="C#" MasterPageFile="~/client/client.Master" AutoEventWireup="true" CodeBehind="invoice.aspx.cs" Inherits="jkgrocery.client.invoice" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <%
        ...
        <tr align="center" style="height:30px;">
            <td colspan="5"><b><h2>Grand Total </h2> </b> </td>
            <td colspan="2" style="color:#33cc33;"><b><h2>&#8377; <% Response.Write(total); dr.Close(); con.Close(); %> </h2> </b></td>
